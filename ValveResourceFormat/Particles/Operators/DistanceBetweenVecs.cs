...
{
    /// <summary>
    /// Remaps the distance between two per-particle vector inputs onto a scalar particle attribute.
    /// With <c>m_bDeltaTime</c> the distance is divided by the frame step first, turning it into a
    /// speed. An input range with equal ends spans one unit rather than acting as a threshold, and the
    /// operator strength interpolates from the value the attribute already holds.
    /// </summary>
    /// <seealso href="https://s2v.app/SchemaExplorer/cs2/particles/C_OP_DistanceBetweenVecs">C_OP_DistanceBetweenVecs</seealso>
