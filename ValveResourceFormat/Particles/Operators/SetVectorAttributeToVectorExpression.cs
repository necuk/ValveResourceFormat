...
namespace ValveResourceFormat.Particles.Operators
{
    ...
    /// a vector particle attribute. The colour and alpha attributes hold a fraction, so a result
    /// written to one of them is clamped to the unit range before the optional normalization.
    /// </summary>
    /// <seealso href="https://s2v.app/SchemaExplorer/cs2/particles/C_OP_SetVectorAttributeToVectorExpression">C_OP_SetVectorAttributeToVectorExpression</seealso>
